      ...
      <div className={`grid gap-4 ${isLargeScreen ? 'grid-cols-1 sm:grid-cols-2 lg:grid-cols-3' : 'grid-cols-1'}`}>
        {buses.map(bus => (
          <div key={bus.bus_number} className="border rounded p-4 font-chakra shadow-lg bg-white">
            <p className="flex items-center"><GiSteeringWheel className="mr-2" /> <strong>Driver Name:</strong> <span className="ml-1 text-gray-700 font-semibold">{bus.driver_name}</span></p>
            <p className="flex items-center"><BsBusFront className="mr-2" /> <strong>Bus Number:</strong> <span className="ml-1 text-gray-700 font-semibold">{bus.bus_number}</span></p>
            <p className="flex items-center"><FaRoute className="mr-2" /> <strong>Route:</strong> <span className="ml-1 text-gray-700 font-semibold">{bus.route}</span></p>
            <p className="flex items-center"><FaMoneyBillAlt className="mr-2" /> <strong>Price:</strong> <span className="ml-1 text-gray-700 font-semibold">₦{bus.fare_amount}</span></p>
            <p className="flex items-center"><PiSeatBold className="mr-2" /> <strong>Capacity:</strong> <span className="ml-1 text-gray-700 font-semibold">{bus.seat_capacity}</span></p>
            <p className="flex items-center"><MdDepartureBoard className="mr-2" /> <strong>Departure Time:</strong> <span className="ml-1 text-gray-700 font-semibold">{bus.departure_time} PM</span></p>
            <button
